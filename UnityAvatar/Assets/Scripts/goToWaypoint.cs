...
public class goToWaypoint : MonoBehaviour {
    ...
    public void Start()
    {
        ...
        _patrolPoints.AddRange(GameObject.FindGameObjectsWithTag("Waypoint"));
        _waypoint = _patrolPoints.Where(gameObject => gameObject.name == "wp_table").SingleOrDefault();
    ...
    private void SetDestination()
    {
        ...
        {
            Vector3 targetVector = _waypoint.transform.position;
